...
export const DEFAULT_ROLE_DEFINITIONS: Array<{
  ...
  },
  {
    ...
    permissions: [
      ...
      PERMISSIONS.SUPPLIER.SUSPEND,
      PERMISSIONS.SUPPLIER.CONTRACT_VIEW,
      PERMISSIONS.SUPPLIER.CONTRACT_MANAGE,
      PERMISSIONS.SUPPLIER.DOCUMENT_MANAGE,
    ],
  },
  {
    ...
    permissions: [
      ...
      PERMISSIONS.WHATSAPP.SEND,
      PERMISSIONS.WHATSAPP.CONVERSATIONS_ASSIGN,
      // Branch-scoped oversight only, same reasoning as this file's other
      // comment above — no approve/suspend/contract-terms authority here.
      PERMISSIONS.SUPPLIER.VIEW,
      PERMISSIONS.SUPPLIER.CONTRACT_VIEW,
    ],
  },
  {
    ...
    permissions: [
      ...
      PERMISSIONS.SEARCH.GLOBAL,
      PERMISSIONS.AI.ANALYTICS_QUERY,
      // Same standing as PERMISSIONS.FLIGHT.SUPPLIER_MANAGE above — supplier
      // credit/contract terms are finance territory.
      PERMISSIONS.SUPPLIER.VIEW,
      PERMISSIONS.SUPPLIER.CREATE,
      PERMISSIONS.SUPPLIER.EDIT,
      PERMISSIONS.SUPPLIER.CONTRACT_VIEW,
